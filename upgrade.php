...
<tr><td>
<b>PHPeasynews - Upgrade (from RC1) script</b>
<br />
<p>Welcome, this upgrade will only work on a current RC1 installation, older versions may appear to upgrade successfully but errors are likely to occur in later stages.</p>
<p>Thank you for picking PHPeasynews again, it's greatly appriciated!</p>
<p>This script will rebuild the config.php file for you, as it has changed slightly, the current database will be perserved though...<br /><br />But don't reset the database, otherwise the database will be deleted, if the upgrade fails it is safe to click "back" and retry as there are no complex upgrades (this script is just building a new config.php file)</p>
...
<br /><br /><i>Your personal login username and password do not need to be entered again, the same one/s will be used after the upgrade</i>
</td></tr>
<tr><td>
<br />
...
echo '<br />';
echo '<font color="red">Failed!';
echo '<br /><br />The Upgrade can not continue, please chmod /includes/config.php to 766 before running this installation again';
echo '</font>';
echo '<br /><br />';
// Page Ended
...
echo '<br /><br /><center><font color="green">PHPeasynews upgraded successfully.</font><br /><br /><b>Security Risk:</b> Please now delete upgrade.php.<br /><br />';
}
